...
{ 
	...
	void GetRotateMatrix44(EMatrix44 &mat, const EVector4D &n, EFloat degree)
	{
		...
		mat.m[0][0] = n.x  *n.x  *oneCosA + cosA;
		mat.m[0][1] = n.x  *n.y  *oneCosA + n.x  *sinA;
		mat.m[0][2] = n.x  *n.z  *oneCosA - n.y  *sinA;
		mat.m[0][3] = 0;
		mat.m[1][0] = n.x  *n.y  *oneCosA - n.z  *sinA;
		mat.m[1][1] = n.y  *n.y  *oneCosA + cosA;
		mat.m[1][2] = n.x  *n.z  *oneCosA + n.y  *sinA;
		mat.m[1][3] = 0;
		mat.m[2][0] = n.x  *n.z  *oneCosA + n.y  *sinA;
		mat.m[2][1] = n.y  *n.z  *oneCosA - n.x  *sinA;
		mat.m[2][2] = n.z  *n.z  *oneCosA + cosA;
		mat.m[2][3] = 0;
		mat.m[3][0] = 0;
		mat.m[3][1] = 0;
		mat.m[3][2] = 0;
